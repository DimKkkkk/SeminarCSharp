...
Console.Clear();
int X = 0, Y = 0;
InitCoordinatesByUser(ref X, ref Y); // Вызов метода с передачей параметров по ссылке (ref). Присваиваем переменные с ref!!! для будущего ввода координат пользователем. Иначе система выдаст нам координаты с нулями.
